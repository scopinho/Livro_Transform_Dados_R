...
Estas são etapas muito importantes para quem trabalha com dados, como por exemplo uma área de negócio de uma organização, buscando tomar decisão com base em dados, ou até mesmo no ciclo de vida de um projeto de ciência de dados.
...
Aleḿ disso, outro motivador para este livro, foi a escassez de documentação sobre o tema em lingua Portuguesa, que apesar dos grandes esforços da comunidade brasileira e voluntários, ainda sofre com falta de acesso para quem não domina o indioma inglês.
...
-   [Visualização de Dados](./Visualizacao/Visualizacao_de_dados_com_ggplot2.html): Traz uma introdução à criação de gráficos através do pacote **ggplot2**. Ver folha da refrência: [data visualization cheatsheet](https://github.com/scopinho/R-cheatsheets/blob/main/translations/portuguese/data-visualization_pt_br.pdf).

::: callout-note
Este livro é de conteúdo público e uma pequena contribuição voluntária. Para acessar o código-fonte e/ou contribuir com correções ou sugestões acesse:
