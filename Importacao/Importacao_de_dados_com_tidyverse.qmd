---
title: "Importação de Dados com TIDYVERSE"
format: html
toc: true
toc-location: right
toc-depth: 4
...
## Especificação de celulas {#especificação-de-celulas-1}

Ver seção [Especificação de celulas](#especificação-de-celulas-1)

## Operadores de arquivos

O pacote googlesheets4 oferece várias forma de manipular os aspectos da planilha como congelar linhas, definir largura das colunas, etc. Acesse [googlesheets4.tydeverse.org](googlesheets4.tydeverse.org) para mais informações.
