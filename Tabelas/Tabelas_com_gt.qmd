...
Podemos agrupar linhas em grupos utilizando a função tab_row_group. Veja este exemplo onde criaremos os grupos de forma manual.
...
#   rows = c(seq(ymd("2010-12-23"), ymd("2010-12-01")))
# )
```
