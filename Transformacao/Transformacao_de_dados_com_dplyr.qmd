...
[![](images/cs-dplyr-01.png)](images/cs-dplyr-01.png)

[![](images/cs-dplyr-02.png)](images/cs-dplyr-02.png)
...
O símbolo **\|\>** é utilizado utilizado para esta finalidade.

**Exemplo**: x \|\> f(y), é o mesmo que f(x,y)

::: callout-note
O símbolo **%\>%** do pacote magrittr também faz a função similar de pipe como o \|\> do R basico, porém com algumas vantagens. Como não precisamos utilizar nada além do pipe básico, a maioria do código deste conteúdo utiliza o \|\>.
:::
